                ...
                {paymentMethod === 'momo' && (
                  <div className="p-4 bg-pink-50 rounded-lg">
                    <p className="text-pink-800">
                      Sau khi nhấn "Tiếp tục", bạn sẽ được chuyển đến ứng dụng MoMo để hoàn tất thanh toán.
                    </p>
                  </div>
                )}
                ...
                {paymentMethod === 'banking' && (
                  <div className="p-4 bg-green-50 rounded-lg">
                    ...
                    <div className="text-sm text-green-700">
                      ...
                      <p><strong>Nội dung:</strong> [Mã đơn hàng]</p>
                    </div>
                  </div>
                )}
                ...
                {paymentMethod === 'cod' && (
                  <div className="p-4 bg-orange-50 rounded-lg">
                    <p className="text-orange-800">
                      Bạn sẽ thanh toán bằng tiền mặt khi nhận hàng. Phí ship sẽ được tính thêm (nếu có).
                    </p>
                  </div>
                )}
              </div>
